...
Welcome to `uniovi-avib-morphingprojections-backend-analytics` contributor's guide.
...
If you experience bugs or general issues with `uniovi-avib-morphingprojections-backend-analytics`, please have a look
...
You can help improve `uniovi-avib-morphingprojections-backend-analytics` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`uniovi-avib-morphingprojections-backend-analytics` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `uniovi-avib-morphingprojections-backend-analytics`'s files. While this mechanism can
...
```
conda create -n uniovi-avib-morphingprojections-backend-analytics python=3 six virtualenv pytest pytest-cov
conda activate uniovi-avib-morphingprojections-backend-analytics
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/uniovi-avib-morphingprojections-backend-analytics.git
...
5. Install [pre-commit]:
   ...
   `uniovi-avib-morphingprojections-backend-analytics` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/uniovi-avib-morphingprojections-backend-analytics
[issue tracker]: https://github.com/<USERNAME>/uniovi-avib-morphingprojections-backend-analytics/issues
